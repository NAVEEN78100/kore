      ...
      <div className="page-container max-w-6xl">
        ...
        >
          ...
          <div className="text-center">
            <h1 className="section-heading mb-2">Order History</h1>
            <p className="section-subtitle mt-0">Track your past and current orders</p>
          </div>
        </motion.div>
        ...
        {!loading && !error && orders.length === 0 && (
          ...
          >
            ...
            <p className="text-slate-600 mb-6">Start your culinary journey by placing your first order!</p>
            <button
              onClick={() => navigate('/menu')}
          ...
          {orders.map((order, index) => {
            ...
            return (
              <motion.div
                ...
                className="surface-card overflow-hidden mb-6 hover:shadow-2xl transition-all duration-300"
              >
                {/* Order Header */}
                <div className="bg-gradient-to-r from-slate-50 to-orange-50 px-6 py-4 border-b border-slate-100">
                ...
                <div className="p-6">
                  <div className="mb-4">
                    <h4 className="text-sm font-medium text-slate-700 mb-3 uppercase tracking-wide">Order Items</h4>
                  ...
                  {canCancel && (
                    <div className="flex justify-end pt-4 border-t border-slate-100">
                      <motion.button
                        ...
                        className="flex items-center gap-2 rounded-2xl border border-red-200 bg-red-50 px-4 py-2 font-medium text-red-600 transition-all hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
